...
public class RabbitmqConfiguration {
	 ...
	 public RabbitTemplate rubeExchangeTemplate() {
	  RabbitTemplate rab = new RabbitTemplate(rabbitConnectionFactory);
	  rab.setExchange("rmq.rube.exchange");
	  rab.setRoutingKey("rube.key");
	  rab.setConnectionFactory(rabbitConnectionFactory);
	  return rab;
	 }
}
